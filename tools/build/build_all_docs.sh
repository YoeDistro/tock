...
# actively changing shape, not close to stabilizing:
...
#     script's aggregator step originally used (passing both
#     --write-doc-meta-dir and --read-doc-meta-dir to one invocation) --
#     that combination is now a hard error, and finalize mode
#     (--read-doc-meta-dir) takes no crate source at all anymore. That's
