 ...
 * Johnathan: The kernel doesn't know the public key in advance. It pulls it out of the header and then checks that the app was encrypted with the private key.
